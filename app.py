...
def on_chat_message(msg):
	...
	if content_type == "text":
		...
		if text.startswith("/start"):
			requests.post("https://api.telegram.org/bot885925187:AAH9GMyKo6EICdqKc5hzHqzXj2Qxyj_PPMQ/sendMessage?chat_id="+str(chat_id)+"&text=Buongiorno, ti auguro di gustarti un buon caffè gratis. 🤙")
