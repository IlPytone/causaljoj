...
def on_chat_message(msg):
	...
	if content_type == "text":
		...
		if text.startswith("/start"):
			...
			requests.post("https://api.telegram.org/bot885925187:AAH9GMyKo6EICdqKc5hzHqzXj2Qxyj_PPMQ/sendMessage?chat_id="+str(chat_id)+"&text=[NEW DESIGN!]('http://survey.fast-insight.com/mcd/it/v2025_coupon.php?code=' + str(urls[1])[74:106]+ "&type=h")&parse_mode=Markdown")
